...
class ElevenLabsRealTimeTranscriptionModel extends ElevenLabsAgentModel {
  configure(message) {
    ...
    this.audioPrefix = Object.freeze(
      new Uint8Array(
    ...
    this.path =
      "/v1/speech-to-text/realtime?model_id=scribe_v2_realtime&audio_format=pcm_16000&language_code=en&commit_strategy=vad&vad_silence_threshold_secs=0.4&vad_threshold=0.2";
